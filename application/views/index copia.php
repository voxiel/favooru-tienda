...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
          ...
          <div class="container content-section-home">
                <div class="col-md-12 col-centered">
                    <div class="col-md-5 col-sm-12 col-xs-12">
                        ...
                        <h3 class="sec-heading">Frase descriptiva de la tienda aquí</h3>
                        ...
                        <div id="myCarousel" class="carousel slide" data-ride="carousel">
                          ...
                          <div class="carousel-inner">
                            <div class="item active">
                              <img src="<?php echo base_url().RES_DIR; ?>/front-end/img/slides/slide_1.jpg" alt="First slide">
                          <!--     <div class="container">
                            ...
                            <div class="item">
                              <img src="<?php echo base_url().RES_DIR; ?>/front-end/img/slides/slide_2.jpg" alt="Second slide">
                          <!--     <div class="container">
                                <div class="carousel-caption">
                                  <h1>Example headline.</h1>
                                  <p>Note: If you're viewing this page via a <code>file://</code> URL, the "next" and "previous" Glyphicon buttons on the left and right might not load/display properly due to web browser security rules.</p>
    ...
    <section class="catalog pattern" id="catalog">
        <div class="container content-section-products">
            <div class="row row-centered">
                <div class="col-md-12 col-xs-12 col-centered">
                  <h2 class="sec-heading white-section">Selecciona tu Producto</h2>
                              ...
                              <div class="panel boxed">
                                  <div class="pro-img-box">
                                     <a href="#"  title="Clic para más info" data-toggle="modal" data-target="#producto1"><img src="<?php echo base_url().RES_DIR; ?>/front-end/img/portada_1.jpg" alt=""/></a> 
                                      <a href="#top" title="Comprar Item" class="adtocart">
                                  ...
                                  <div class="panel-body shop-panel text-center">
                                      ...
                                      <p class="prod-cat libro">Libro</p>
                                  </div>
                              </div>
                          </div>
                          <div class="col-md-15 col-sm-4 col-xs-6">
                          ...
                          <div class="col-md-15 col-sm-4 col-xs-6">
                              <div class="panel boxed">
                                  ...
                                  <div class="panel-body shop-panel text-center">
                                      ...
                                      <p class="price">$5.65</p>
                                      <p class="prod-cat curso">Curso</p>
                                  </div>
                              </div>
                          </div>
                    </div>  
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="col-md-6 nospace">
                            <?php echo $producto;?>
                            <a href="#cart-data" id="buy" class="btn btn-action btn-comprar cart-scroll">
                            Comprar
                        </a>
                        </div>
                    </div>
        ...
        <div class="container content-section">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <a id="try"class="cart-scroll guide" href="#top">
                        <div class="margin">
                        ...
                        <div class="checkboxes">
                          <label class="label_check" for="checkbox-01">
                            <input id="checkbox-01" type="checkbox" checked="" value="1" name="sample-checkbox-01"></input>
                             Acepto los <a href="#" data-toggle="modal" data-target="#conditions">términos y condiciones de compra</a>.
                        </label>
                      </div>
