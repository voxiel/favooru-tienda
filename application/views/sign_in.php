        ...
        <div class="span6 center-span">
            ...
            <div class="well center">
                ...
                <div class="control-group <?php echo (form_error('sign_in_username_email') || isset($sign_in_username_email_error)) ? 'error' : ''; ?>">
                    <!-- <label class="control-label" for="sign_in_username_email"><?php echo 'Usuario'; ?></label> -->
                    ...
                    <div class="login">
                       ...
                       <span class="field_error"><?php echo $sign_in_username_email_error; ?></span>
                        ...
                        <?php endif; ?>
						<?php echo form_input(array('name' => 'sign_in_username_email', 'id' => 'sign_in_username_email', 'value' => set_value('sign_in_username_email'), 'maxlength' => '24', 'placeholder' => 'Usuario')); ?>
					
                    </div>
                </div>

                <div class="control-group <?php echo form_error('sign_in_password') ? 'error' : ''; ?>">
                   <!--  <label class="control-label" for="sign_in_password"><?php echo 'Contraseña'; ?></label> -->

                    <div class="login">
                        <?php if (form_error('sign_in_password')) : ?>
                            <span class="help-inline"><?php echo form_error('sign_in_password'); ?></span>
                        <?php endif; ?>
						<?php echo form_password(array('name' => 'sign_in_password', 'id' => 'sign_in_password', 'value' => set_value('sign_in_password'), 'placeholder' => 'Contraseña')); ?>
          ...
          <!--       <div class="control-group">
                ...
                <div>
					<?php echo form_button(array('type' => 'submit', 'class' => 'btn btn-large', 'content' => '<i class="icon-lock"></i> '.'Iniciar sesión')); ?>
                </div>
