 ...
 */
class favooru_afiliados extends CI_Controller {
  ...
  function index()
  {
    ...
    {
      redirect('account/sign_in/?continue='.urlencode(base_url().'index.php/account/favooru_afiliados'));
    }
    ...
    $all_accounts = $this->account_model->get_afiliados();
    ...
    {
      $current_user = array();
      $current_user['afiliados_id'] = $acc->afiliados_id;
      $current_user['afiliados_nombre'] = $acc->afiliados_nombre;
      $current_user['afiliados_correo'] = $acc->afiliados_correo;
      $current_user['afiliados_fecha_nac'] = $acc->afiliados_fecha_nac;
      $current_user['afiliados_link_fb'] = $acc->afiliados_link_fb;
    ...
    $this->load->view('account/favooru_afiliados', $data);
  }
