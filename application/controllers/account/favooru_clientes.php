 ...
 */
class favooru_clientes extends CI_Controller {
  ...
  function index()
  {
    ...
    {
      redirect('account/sign_in/?continue='.urlencode(base_url().'index.php/account/favooru_clientes'));
    }
    ...
    {
      $current_user = array();
      $current_user['cliente_id'] = $acc->cliente_id;
      $current_user['cliente_nombres'] = $acc->cliente_nombres;
      $current_user['cliente_apellidos'] = $acc->cliente_apellidos;
    ...
    $this->load->view('account/favooru_clientes', $data);
  }
