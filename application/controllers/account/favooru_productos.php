 ...
 */
class favooru_productos extends CI_Controller {
  ...
  function index()
  {
    ...
    {
      redirect('account/sign_in/?continue='.urlencode(base_url().'index.php/account/favooru_productos'));
    }
    ...
    $all_accounts = $this->account_model->get_productos();
    ...
    $this->load->view('account/favooru_productos', $data);
  }
