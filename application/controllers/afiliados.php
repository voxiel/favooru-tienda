...
/*
		...
		$this->form_validation->set_rules('buy_bith_date', 'Fecha de Nacimiento', 'required');

		if ($this->form_validation->run() == FALSE)
        {
                        
            echo json_encode(array('st'=>0, 'msg' => validation_errors()));
            //print_r(array('st'=>0, 'msg' => validation_errors()));
        }
        else
        {
        	//Calculate();
		...
		*/
        ...
        echo json_encode(array('msg'=>$this->input->post('buy_email')));
	}
